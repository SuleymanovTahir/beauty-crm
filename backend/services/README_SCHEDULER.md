...
PYTHONPATH=/Users/tahir/Desktop/beauty-crm/backend python3 services/notification_scheduler.py
```
...
* * * * * cd /Users/tahir/Desktop/beauty-crm/backend && PYTHONPATH=/Users/tahir/Desktop/beauty-crm/backend python3 services/notification_scheduler.py >> /tmp/notification_scheduler.log 2>&1
```
...
ExecStart=/usr/bin/python3 /Users/tahir/Desktop/beauty-crm/backend/services/notification_scheduler.py
Restart=always
RestartSec=10
