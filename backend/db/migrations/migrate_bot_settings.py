...
→ Ты расслабленнее: "Супер выбор! 💅 Завтра в 3 есть окно, успеешь?"
...
Пока решаешь - могу кинуть:
→ Отзывы клиентов
→ Портфолио мастеров в Highlights

Кстати, на этой неделе почти всё забито. Если надумаешь - пиши сразу, найдём окно 👌""",
...
= Экономишь 2+ часа в месяц vs обычный лак
...
Мастер аккуратно работает. Нужен перерыв — скажешь.
...
Лучше 1 раз качественно, чем 3 раза переделывать. Согласна?""",
...
Покажи мужу наш Instagram — там реальные фото работ.
Или отзывы клиентов.

Кстати, у нас много пар приходят — пока жена на процедуре, муж гуляет по Marina 😊

Окна на этой неделе быстро заполняются. Как решишь — сразу пиши!""",

    "objection_first_time": """Отлично что решилась попробовать! 🎉

Для первого раза это идеально:
✅ Мастер объяснит каждый шаг  
✅ Можешь задать любые вопросы
...
2. Обсудит детально твои пожелания  
...
4️⃣ ПРЕДЛАГАЙ КОНКРЕТНОЕ время:
   ...
   ✅ "Ближайшее окно — сегодня в 17:00 у Марии. Успеешь?"
