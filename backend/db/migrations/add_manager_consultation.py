...
def add_manager_consultation_field():
    ...
    try:
        ...
        if 'manager_consultation_prompt' not in columns:
            print("➕ Добавляем поле manager_consultation_prompt...")
            c.execute("""
                ALTER TABLE bot_settings 
                ADD COLUMN manager_consultation_prompt TEXT DEFAULT ''
            """)
            
            # Заполняем дефолтным значением
...
"""
            ...
            conn.commit()
            print("✅ Поле manager_consultation_prompt добавлено и заполнено!")
        else:
            print("ℹ️  Поле manager_consultation_prompt уже существует")
...
if __name__ == "__main__":
    print("=" * 70)
    print("🔧 МИГРАЦИЯ: Добавление поля для консультации менеджера")
    print("=" * 70)
