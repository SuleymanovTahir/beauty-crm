...
def run_all_migrations():
    ...
    # ========================================================================
    # TEST USERS MIGRATION (OPTIONAL - FOR DEVELOPMENT)
    # ========================================================================
    print_header("МИГРАЦИЯ: ТЕСТОВЫЕ ПОЛЬЗОВАТЕЛИ")

    from db.migrations.add_test_users_migration import migration_add_test_users
    results["test_data/test_users"] = run_migration_function(
