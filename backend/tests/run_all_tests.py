...
def run_all_tests():
    ...
    # ✅ ПЕРЕД ПРОВЕРКОЙ: Запускаем скрипт исправления (назначение мастеров)
    # Это нужно т.к. некоторые тесты (test_employee_management) 
    # могут удалять связи при тестировании синхронизации CSV.
    try:
        ...
        print(f"⚠️ Ошибка при авто-назначении услуг: {e}")
