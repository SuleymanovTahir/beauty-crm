...
class SalonBot:
    ...
    def _get_fallback_response(self, language: str = 'ru') -> str:
        ...
        responses = {
            'ru': "Спасибо за обращение! Передаю вашу заявку нашему менеджеру - он свяжется с вами в ближайшее время и поможет с записью! 💎",
            'en': "Thank you for reaching out! I'm transferring your request to our manager - they will contact you shortly and help with booking! 💎",
            'ar': "شكراً لتواصلك معنا! سأحول طلبك إلى مديرنا - سيتواصل معك قريباً ويساعدك في الحجز! 💎"
        }
