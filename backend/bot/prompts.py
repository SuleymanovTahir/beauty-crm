...
⚠️ КРИТИЧЕСКИ ВАЖНО! Когда ты ПОДТВЕРЖДАЕШЬ запись клиенту и говоришь "Записал вас" или "Записываю вас" -
ты ОБЯЗАТЕЛЬНО должен добавить в конец своего сообщения специальную команду (на отдельной строке):
...
"Отлично! Записал вас на маникюр к Ляззат на завтра в 16:00! До встречи! 💎
...
⚠️ НЕ ЗАБЫВАЙ добавлять эту команду КАЖДЫЙ РАЗ когда подтверждаешь запись!
Без этой команды запись НЕ БУДЕТ СОХРАНЕНА в системе!"""
