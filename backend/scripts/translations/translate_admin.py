#!/usr/bin/env python3
"""
Translate ONLY admin panel content:
- Frontend: src/pages/admin/**, src/pages/adminPanel/**
- No database translations (admin doesn't need DB content)
"""
...
ADMIN_PATHS = [
    FRONTEND_DIR / "src" / "pages" / "admin",
    FRONTEND_DIR / "src" / "pages" / "adminPanel"
]
...
def main():
    print("👨‍💼 Translating ADMIN panel content only...")
