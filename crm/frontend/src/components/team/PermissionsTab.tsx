// /frontend/src/components/team/PermissionsTab.tsx
/**
...
export function PermissionsTab({ userId }: PermissionsTabProps) {
  const { t } = useTranslation(['crm-components', 'common']);
        ...
        <div className="space-y-6">
          <div>
            <Label>{t('crm-components:current_role')}</Label>
              ...
              <p className="text-sm text-gray-600">
                {t('crm-components:hierarchy_level')}: {userPermissions.role_info.hierarchy_level}
              </p>
            </div>
          </div>

          <div>
            <Label htmlFor="role_select">{t('crm-components:change_role_to')}</Label>
            <select
              id="role_select"
              value={selectedRole}
          ...
          <div className="rounded-xl border border-gray-200 p-4 bg-gray-50">
            ...
            <p className="text-xs text-gray-500 mt-3">
              {t('common:status', 'Статус')}: {payrollAccessEnabled ? t('crm-components:status_active', 'Активно') : t('crm-components:status_inactive', 'Неактивно')}
            </p>
          </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-xl text-gray-900 font-semibold">
            {t('crm-components:access_rights')}
          </h2>
