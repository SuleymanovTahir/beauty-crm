...
const PendingRegistrations: React.FC = () => {
    ...
    const fetchPendingUsers = async () => {
        ...
        try {
            const response = await fetch(buildApiUrl('/api/admin/registrations/pending'), {
                credentials: 'include'
            });
    ...
    const handleApprove = async (userId: number) => {
        ...
        try {
            const response = await fetch(buildApiUrl('/api/admin/registrations/approve'), {
                method: 'POST',
                headers: {
    ...
    const handleReject = async (userId: number) => {
        ...
        try {
            const response = await fetch(buildApiUrl('/api/admin/registrations/reject'), {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
    ...
    const handleSaveEdit = async () => {
        ...
        setSavingEdit(true);
        try {
            const response = await fetch(buildApiUrl(`/api/admin/registrations/${editingUser.id}`), {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json'
                },
    ...
    const handleDelete = async (userId: number) => {
        ...
        setActionLoading(userId);
        try {
            const response = await fetch(buildApiUrl(`/api/admin/registrations/${userId}`), {
                method: 'DELETE',
                credentials: 'include'
            });
