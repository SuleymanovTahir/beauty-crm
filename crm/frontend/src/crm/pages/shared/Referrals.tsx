...
export default function UniversalReferrals() {
    ...
    const loadReferrals = async () => {
        try {
            ...
            const response = await fetch(buildApiUrl(`/api/admin/referrals?${params.toString()}`), {
                credentials: 'include',
            });
    ...
    const loadSettings = async () => {
        try {
            const response = await fetch(buildApiUrl('/api/admin/referrals/settings'), { credentials: 'include' });
            if (response.ok) {
                const data = await response.json();
    ...
    const loadStats = async () => {
        try {
            const response = await fetch(buildApiUrl('/api/admin/referrals/stats'), { credentials: 'include' });
            if (response.ok) {
                const data = await response.json();
    ...
    const handleSaveSettings = async () => {
        try {
            const response = await fetch(buildApiUrl('/api/admin/referrals/settings'), {
                method: 'PUT',
