...
// /frontend/src/pages/shared/EmployeeDetail.tsx
...
import { EmployeeInformation } from '../../components/team/EmployeeInformation';
import { EmployeeServices } from '../../components/team/EmployeeServices';
import { EmployeeSchedule } from '../../components/team/EmployeeSchedule';
import { EmployeePayroll } from '../../components/team/EmployeePayroll';
import { EmployeeOnlineBooking } from '../../components/team/EmployeeOnlineBooking';
...
export default function EmployeeDetail() {
    ...
    const activeTab = tab === 'bookings' || tab === 'settings' ? 'schedule' : (tab || 'information');
    ...
    const rolePrefix = window.location.pathname.startsWith('/manager')
            ? '/manager'
            : '/crm';
