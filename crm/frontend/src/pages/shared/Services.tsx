...
export default function UniversalServices() {
    ...
    const loadData = async () => {
        try {
            ...
            if (isEmployee) {
                const response = await fetch(buildApiUrl('/api/my/services'), { credentials: 'include' });
    ...
    const loadHistory = async () => {
        ...
        try {
            const response = await fetch(buildApiUrl('/api/my/change-requests'), { credentials: 'include' });
    ...
    const handleSave = async () => {
        ...
        try {
            if (isEmployee && editingService !== null) {
                ...
                const response = await fetch(buildApiUrl(`/api/my/services/${editingService.id}/request-change`), {
                    method: 'POST',
    ...
    const handleCancelRequest = async (serviceId: number) => {
        try {
            await fetch(buildApiUrl(`/api/my/services/${serviceId}/cancel-request`), { method: 'DELETE', credentials: 'include' });
