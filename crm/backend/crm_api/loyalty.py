...
async def get_loyalty_tiers_admin(session_token: Optional[str] = Cookie(None)):
    ...
    from crm_api.admin_features import get_loyalty_tiers as get_loyalty_tiers_handler
...
async def update_loyalty_tier_admin(
    ...
    from crm_api.admin_features import update_loyalty_tier as update_loyalty_tier_handler
...
async def create_loyalty_tier_admin(
    ...
    from crm_api.admin_features import create_loyalty_tier as create_loyalty_tier_handler
...
async def delete_loyalty_tier_admin(
    ...
    from crm_api.admin_features import delete_loyalty_tier as delete_loyalty_tier_handler
...
async def get_loyalty_transactions_admin(session_token: Optional[str] = Cookie(None)):
    ...
    from crm_api.admin_features import get_loyalty_transactions as get_loyalty_transactions_handler
...
async def delete_loyalty_transaction_admin(
    ...
    from crm_api.admin_features import delete_loyalty_transaction as delete_loyalty_transaction_handler
...
async def adjust_loyalty_points_admin(request: Request, session_token: Optional[str] = Cookie(None)):
    ...
    from crm_api.admin_features import adjust_loyalty_points as adjust_loyalty_points_handler
...
async def get_loyalty_stats_admin(session_token: Optional[str] = Cookie(None)):
    ...
    from crm_api.admin_features import get_loyalty_stats as get_loyalty_stats_handler
