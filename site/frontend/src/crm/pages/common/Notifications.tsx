...
export default function NotificationsPage() {
    ...
    const handleMarkAllRead = async () => {
        try {
            ...
            toast.error(t('error_marking_notifications'));
        }
    };
    ...
    const handleClearAll = async () => {
        ...
        try {
            ...
            toast.error(t('error_deleting_notifications'));
        }
    };
    ...
    const handleDeleteSelected = async () => {
        ...
        try {
            ...
            toast.error(t('error_deleting_selected'));
        }
    };
            ...
            <div className="mb-8">
                ...
                {notifications.length > 0 && (
                    <div className="flex items-center gap-3 mb-4 p-2">
                        ...
                        />
                        <span className="text-sm text-gray-600 font-medium">{t('select_all')}</span>
                    </div>
                )}
            </div>
                    ...
                    {notifications.map((notif) => (
                        ...
                        >
                            <div className="pt-1.5 flex flex-col items-center gap-2">
                                ...
                                />
                                {!notif.is_read && (
                                    <div className="w-3 h-3 bg-blue-500 rounded-full flex-shrink-0 animate-pulse" title={t('unread')}></div>
                                )}
                            </div>
