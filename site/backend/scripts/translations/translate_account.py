#!/usr/bin/env python3
"""
Translate ONLY client account content:
- Frontend: public_landing/pages/account/** (booking wizard, account pages)
...
def main():
    print("👤 Translating CLIENT ACCOUNT content only...")
