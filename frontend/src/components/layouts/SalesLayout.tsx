...
export default function SalesLayout({ user, onLogout }: SalesLayoutProps) {
  ...
  const menuItems = useMemo(() => {
    const allItems = [
      { icon: Users, label: 'Клиенты', path: '/sales/clients', requirePermission: () => true },
      { icon: MessageSquare, label: 'Чат', path: '/sales/chat', hasSubmenu: true, requirePermission: () => permissions.canViewInstagramChat },
