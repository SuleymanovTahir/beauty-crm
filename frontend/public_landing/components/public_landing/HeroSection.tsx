...
export function HeroSection() {
  ...
  return (
    <section className="relative min-h-screen flex items-center bg-[#c9c7bc]" style={{ marginTop: '-80px', paddingTop: '80px' }}>
      {/* Full screen background image with model */}
      <div className="absolute inset-0 z-0">
        <img 
          src="https://images.unsplash.com/photo-1555324625-4d0d3cd9d5e4?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxiZWF1dHklMjBtb2RlbCUyMGZhY2UlMjBwb3J0cmFpdHxlbnwxfHx8fDE3NjQxNjM4NDN8MA&ixlib=rb-4.1.0&q=80&w=1080"
          alt="M Le Diamant Model"
          className="w-full h-full object-cover"
        />
        <div className="absolute inset-0 bg-gradient-to-r from-[#c9c7bc]/95 via-[#c9c7bc]/50 to-transparent" />
      </div>
