      ...
      <div className="max-w-4xl">
        ...
        <div className="grid grid-cols-2 gap-4 mb-6">
          <div className="bg-white rounded-xl border border-gray-200 p-5">
            ...
            <div className="text-2xl font-bold">{formatCurrency(150)}</div>
          </div>
          <div className="bg-white rounded-xl border border-gray-200 p-5">
        ...
        <div className="mb-6">
          ...
          <div className="grid grid-cols-2 gap-4 mb-4">
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-5">
              ...
              <div className="text-xs text-gray-500">1 point = 1 {currency} discount</div>
            </div>
          </div>
        </div>
              ...
              {menuItems.map((item) => {
                ...
                return (
                  <button
                    ...
                    className={`w - full flex items - center gap - 3 px - 3 py - 2 rounded - lg text - sm ${activeTab === item.id
