              ...
              <div className="flex items-center justify-between">
                ...
                <div
                  className={`w-6 h-6 rounded-full border-2 ${
                    !selectedMaster ? 'border-black bg-black' : 'border-muted-foreground/30'
              ...
              >
                <CardContent className="p-6 space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <div
                      className={`w-6 h-6 rounded-full border-2 ${
                        isSelected ? 'border-black bg-black' : 'border-muted-foreground/30'
                      } flex items-center justify-center`}
                    >
            ...
            {categories.map(c => (
              <Button
                ...
                className={`whitespace-nowrap rounded-full ${
                  selectedCategory === c ? 'bg-black text-white hover:bg-black/90' : ''
                }`}
              >
                {c}
              </Button>
