  ...
  const masters = [
    {
      name: t.master1Name,
      role: t.master1Role,
      experience: t.master1Exp,
      certification: t.master1Cert,
    ...
    },
    {
      name: t.master2Name,
      role: t.master2Role,
      experience: t.master2Exp,
      certification: t.master2Cert,
    ...
    },
    {
      name: t.master3Name,
      role: t.master3Role,
      experience: t.master3Exp,
      certification: t.master3Cert,
      ...
      <section className="py-24 px-6 lg:px-12 bg-white" dir={language === 'ar' ? 'rtl' : 'ltr'}>
        <div className="container mx-auto max-w-7xl">
          <div className="text-center mb-16">
            <p className="text-[#b8a574] uppercase tracking-[0.2em] mb-4">{t.mastersTag}</p>
