    ...
    <section className="py-24 px-6 lg:px-12 bg-white" dir={language === 'ar' ? 'rtl' : 'ltr'}>
      <div className="container mx-auto max-w-5xl">
        <div className="text-center mb-16">
          <p className="text-[#b8a574] uppercase tracking-[0.2em] mb-4">{t.pricingTag}</p>
          <h2 className="text-[#2d2d2d] mb-6">
            {t.pricingTitle}
          </h2>
          <div className="inline-block px-8 py-4 bg-[#b8a574] text-white rounded-full shadow-md">
            {t.pricingDiscount}
          </div>
        </div>
        ...
        <div className="space-y-8">
          {pricingCategories.map((category, categoryIndex) => (
            <div key={categoryIndex} className="bg-[#f5f3ef] rounded-2xl p-8 shadow-sm hover:shadow-md transition-shadow">
              <h3 className="text-[#2d2d2d] mb-8 pb-4 border-b-2 border-[#b8a574] tracking-wider">
                {category.title}
              </h3>
                ...
                {category.services.map((service, serviceIndex) => (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <span className="text-2xl text-[#b8a574]">
                        AED {service.price}
                      </span>
                    </div>
                  </div>
