...
const navigation = [
    { name: "Ногти", href: "#services-section" },
    { name: "Волосы", href: "#services-section" },
    { name: "Брови", href: "#services-section" },
    { name: "Цены", href: "#services-section" },
    { name: "Контакты", href: "#booking-section" },
];
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center h-20">
                    <div className="flex-shrink-0">
                        <span className="text-2xl tracking-tight text-primary">M. Le Diamant</span>
                    </div>
